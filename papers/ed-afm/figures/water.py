...
if __name__ == "__main__":
    ...
    molecules = [data_dir / 'Water' / 'mol.xyz']
    ...
    data1 = np.load(data_dir / 'Water' / 'data_CO_exp.npz')
    X1 = data1['data']
    afm_dim1 = (data1['lengthX'], data1['lengthY'])

    data2 = np.load(data_dir / 'Water' / 'data_Xe_exp.npz')
    X2 = data2['data']
    ...
    xyz_img = np.flipud(imageio.imread(data_dir / 'Water' / 'mol.png'))
