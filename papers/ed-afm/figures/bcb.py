...
if __name__ == "__main__":
    ...
    afmulator_args = {
        "pixPerAngstrome"   : 20,
        "scan_dim"          : (128, 128, 19),
        "scan_window"       : ((2.0, 2.0, 7.0), (18.0, 18.0, 8.9)),
        "df_steps"          : 10,
        "tipR0"             : [0.0, 0.0, 4.0]
    }
    ...
    molecules = [data_dir / "BCB" / "mol.xyz"]
    ...
    data1 = np.load(data_dir / "BCB" / "data_CO_exp.npz")
    X1 = data1["data"]
    afm_dim1 = (data1["lengthX"], data1["lengthY"])

    data2 = np.load(data_dir / "BCB" / "data_Xe_exp.npz")
    X2 = data2["data"]
    ...
    with torch.no_grad():
        ...
        pred_exp, attentions_exp = model(X_exp_cuda)
    ...
    xyz_img = np.flipud(imageio.imread(data_dir / "BCB" / "mol.png"))
