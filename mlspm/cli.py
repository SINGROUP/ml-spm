...
def parse_args() -> dict:
    ...
    parser.add_argument("--batch_log_path", type=str, default='batches.log')
    parser.add_argument("--train", type=_bool_type, default=True)
    parser.add_argument("--val", type=_bool_type, default=True)
    ...
    parser.add_argument("--timings", type=bool, action='store_true')
